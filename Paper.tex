...
Another aspect is that feature modeling is in its core a simple concept. Even though its impact in the industry is pretty big considering it is the most popular concept for variability modeling in software system until today.\cite{b9} One can say that because it is such a simple concept and due to the big amount of research in this field we understand the subject pretty well by now.\\
...
\item \textit{Poor user-friendliness} can be introduced by poor handling of variability, which decreases the usebility of a system. As an example if you \\
\end{itemize}
