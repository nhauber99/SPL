...
Some of them are using contraints, similar to the approach used in feature modeling. Another approach for modeling dependencies is with rules or decisions, which are are checked when a decision is taken.\cite{b11} \\
